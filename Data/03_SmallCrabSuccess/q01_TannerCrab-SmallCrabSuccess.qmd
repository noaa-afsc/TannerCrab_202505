...
Small Tanner crab crab encountered during the NMFS EBS bottom trawl surveys in 2003-2005 and 2008-2010 successfully propagated to larger sizes while the cohort first observed in 2017-2019 did not (Figure [-@fig-SCsxs-ZCs]). The SSC requested that the author explore whether the successful cohorts showed differences in habitat use compared with the unsuccessful one that may have contributed to their success. Furthermore, the SSC recommended that a comparison of environmental conditions experienced by small crabs during these periods may help to elucidate why some cohorts appear to propagate and others do not. Here, I present some simple comparisons between the cohorts using NMFS EBS bottom trawl survey data with regards to bottom temperatures occupied (Figures [-@fig-SCsxs-SCAvT] and [-@fig-SCsxs-TvSCA]), overlap with large crab (Figures [-@fig-SCsxs-SCAvLCA] and [-@fig-SCsxs-LCAvSCA]), the distribution of small crab with respect to bottom temperature and large crab abundance jointly (Figures [-@fig-SCsxs-H2Ds1]-[-@fig-SCsxs-H2Ds3]), and finally the geographic distributions of the cohorts with respect to location on the EBS shelf and relation to the cold pool (Figure [-@fig-SCsxs-Maps]). Bottom temperature was chosen because the it is important for physiological processes and regulates feeding, respiration, and growth while they were available as part of the survey data. Large crab CPUE was chosen because of the possibility that predation by, or competition with, large crab might have a substantial effect on small crab survival. In addition, both were available in the survey data.
...
There seemed to be little difference between the cohorts in terms of the densities of large crab experienced by small crab, or the densities of small crab associated with large crab (Figures [-@fig-SCsxs-SCAvLCA] and [-@fig-SCsxs-LCAvSCA]). The two successful cohorts appeared to occupy a wider range of temperature and large crab densities than the unsuccessful cohort, in which most crab were associated with warm temperatures and low large crab density (Figures [-@fig-SCsxs-H2Ds1]-[-@fig-SCsxs-H2Ds3]). The location and size of the cold pool varied annually in relation to spatial extent of the three cohorts, with no clear pattern apparent (Figure [-@fig-SCsxs-Maps]). It was small and located to the northwest during 2003-05, extensive during 2008-10, and started out extensive but then essentially disappeared after the first year in 2017-2019.

The one clear difference between the two successful cohorts and one unsuccessful cohort is that of mean bottom temperature, with the two successful cohorts occupying colder temperatures than the unsuccessful cohort. A more nuanced analysis might pull out more subtle relationships, but any further analysis faces the issue of small sample size (two successful cohorts, one unsuccessful) and the potential for identifying spurious relationships. Expanding the time frame considered to the entire period covered by the NMF survey might increase the sample size by a factor of three or four successful/unsuccessful cohorts over the 50 year extent of the survey. Further work needs to be done in coordination with SAP and perhaps be led by analysts developing the Tanner crab ESP.
