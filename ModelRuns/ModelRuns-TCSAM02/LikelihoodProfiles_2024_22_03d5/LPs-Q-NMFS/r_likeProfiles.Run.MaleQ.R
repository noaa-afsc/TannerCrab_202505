#--run likelihood profile on pQ[2] (male NMFS Q for 1982+) parameter
#--Notes:
#--1. modify MPI file:
...
base<-0.5048964;#--base case (limits: 0.01   1.1)
cases1<-seq(from= 0.51,to= 1.00,by= 0.01);
cases2<-seq(from= 0.50,to= 0.10,by=-0.01);
